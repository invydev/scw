...
<title>Crate Web P | Anti Curl</title>
...
<div id="info-message" class="hidden fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-xs w-80 bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-6 py-5 rounded-xl shadow-2xl flex flex-col items-center space-y-4 opacity-0 pointer-events-none transition-opacity duration-500 z-50">
  ...
  <a href="https://www.mediafire.com/filezx" download class="flex items-center space-x-2 bg-white text-blue-700 px-5 py-2 rounded-full text-sm font-semibold shadow-md hover:shadow-lg hover:bg-gray-100 transition-transform transform hover:scale-105">
...
<form method="post" action="proses.php" class="rounded-lg overflow-hidden shadow-md">
  ...
  <img src="https://files.catbox.moe/2enklv.jpg" alt="Product 1 image" class="w-full object-contain bg-[#0050FF]" height="150" width="150" />
  <div class="px-3 py-2 bg-white">
    <div class="inline-block bg-[#0050FF] text-white text-xs rounded px-2 py-0.5 mb-1">
      <i class="fas fa-boxes mr-1"></i>Free
    </div>
    <p class="text-base font-normal leading-tight">Terabox</p>
  </div>
...
<form method="post" action="proses.php" class="rounded-lg overflow-hidden shadow-md">
  ...
  <img src="https://images.cahyosr.my.id/cahyo/18.jpg" alt="Product 1 image" class="w-full object-contain bg-[#0050FF]" height="150" width="150" />
  <div class="px-3 py-2 bg-white">
    <div class="inline-block bg-[#0050FF] text-white text-xs rounded px-2 py-0.5 mb-1">
      <i class="fas fa-boxes mr-1"></i>Free
    </div>
